...
<figure>
  <Image
    src="/images/outage-detection-diagram.png"  // Image path relative to /public
    alt="A diagram representing logical scenarios in testing an algorithm for power outage detection."
    width={800}      // Set an appropriate width
    height={600}     // Set an appropriate height
  />
  <figcaption>
    A diagram representing logical scenarios in testing an algorithm for power outage detection.
  </figcaption>
</figure>
