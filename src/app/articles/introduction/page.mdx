...
import image1 from '@/images/photos/welcome_fig1.jpg'
import image2 from '@/images/photos/welcome_fig2.png'
import image3 from '@/images/photos/welcome_fig3.png'
import image4 from '@/images/photos/welcome_fig4.jpg'
import image5 from '@/images/photos/welcome_fig5.JPG'
...
<figure>
  <img src={image1.src} alt="Picture from a retro-themed party." width="400" height="200" />
  <figcaption>Fig 1: Picture from a retro-themed party.</figcaption>
</figure>
...
<figure>
  <img src={image2.src} alt="A set of logical scenarios in testing an algorithm for power outage detection." width="400" height="200" />
  <figcaption>Fig 2: A set of logical scenarios in testing an algorithm for power outage detection.</figcaption>
</figure>
...
<figure>
  <img src={image3.src} alt="A mug I received from KamiLimu, a tech mentorship programme, where I was a judge during the tech entrepreneurship pitches in Cohort 8." width="400" height="200" />
  <figcaption>Fig 3: A mug I received from KamiLimu, a tech mentorship programme, where I was a judge during the tech entrepreneurship pitches in Cohort 8. Inscription: I am on record as someone who knows things, so I teach</figcaption>
</figure>
...
<figure>
  <img src={image4.src} alt="Summit of Lion Head Mountain, Cape Town, South Africa." width="400" height="200" />
  <figcaption>Fig 4: Summit of Lion Head Mountain, Cape Town, South Africa.</figcaption>
</figure>
...
<figure>
  <img src={image5.src} alt="Zebra Rocks, Mt. Kilimanjaro (~4200m asl)." width="400" height="200" />
  <figcaption>Fig 5: Zebra Rocks, Mt. Kilimanjaro (~4200m asl).</figcaption>
</figure>
